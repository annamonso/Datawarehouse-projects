...
package dw_project2.controljob_0_1;
 ...
 * @status
 */
public class ControlJob implements TalendJob {
	...
	private final String jobName = "ControlJob";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(ControlJob.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row10Struct implements routines.system.IPersistableRow<row10Struct> {
		final static byte[] commonByteArrayLock_DW_PROJECT2_ControlJob = new byte[0];
		static byte[] commonByteArray_DW_PROJECT2_ControlJob = new byte[0];

		public void readData(ObjectInputStream dis) {

			synchronized (commonByteArrayLock_DW_PROJECT2_ControlJob) {
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				dw_project2.monthdimension_0_1.MonthDimension childJob_tRunJob_1 = new dw_project2.monthdimension_0_1.MonthDimension();
				// pass DataSources
				...
				for (String[] item_tRunJob_1 : childReturn_tRunJob_1) {
					...
					dw_project2.peopledimension2_0_1.PEOPLEDIMENSION2 childJob_tRunJob_2 = new dw_project2.peopledimension2_0_1.PEOPLEDIMENSION2();
					// pass DataSources
					...
					dw_project2.aircraftdimension_0_1.AircraftDimension childJob_tRunJob_3 = new dw_project2.aircraftdimension_0_1.AircraftDimension();
					// pass DataSources
					...
					dw_project2.logbookregistration2_0_1.LogbookRegistration2 childJob_tRunJob_4 = new dw_project2.logbookregistration2_0_1.LogbookRegistration2();
					// pass DataSources
					...
					dw_project2.temporaldimension_0_1.TemporalDimension childJob_tRunJob_5 = new dw_project2.temporaldimension_0_1.TemporalDimension();
					// pass DataSources
					...
					dw_project2.aircraftutilization_0_1.AircraftUtilization childJob_tRunJob_6 = new dw_project2.aircraftutilization_0_1.AircraftUtilization();
					// pass DataSources
	...
	public static void main(String[] args) {
		final ControlJob ControlJobClass = new ControlJob();

		int exitCode = ControlJobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ControlJob.class.getClassLoader()
					.getResourceAsStream("dw_project2/controljob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = ControlJob.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ControlJob");
		}
...
/************************************************************************************************
 * 88141 characters generated by Talend Open Studio for Data Integration on the
 * 17 de diciembre de 2024, 22:29:46 CET
 ************************************************************************************************/